...
namespace test1Xamrin
{
    ...
    {
        private readonly Framework.HttpClient _httpClient = new Framework.HttpClient();
        ...
        public async Task EnsureConversationEstablished()
        {
            var activity = new Activity()
            {
                ...
                ServiceUrl = "https://einvoice-82d9.azurewebsites.net" //"https://localhost:44338"
            };
            ...
            var request = new HttpRequest()
            {
                ...
                Url = "https://einvoice-82d9.azurewebsites.net/api/messages",// "https://localhost:44338/api/messages",
